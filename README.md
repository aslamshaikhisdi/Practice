...
# SQL ProtFolio Project 1

This is the very first project on SQL. 
We will be learning how to analyze the data in SQL alogn with the manupulation from start to end. 
